...
public class MainMenu {
    ...
    private void drawImageButton(Graphics2D g, Rectangle rect, BufferedImage normalImg, BufferedImage hoverImg, boolean hover, String text) {
        if (rect == null) return;
    ...
    private void drawVolumeControl(Graphics2D g) {
        ...
        if (icon != null) {
            ...
            int drawY = volumeIconRect.y - 10;  // 🔥 改這個數字
