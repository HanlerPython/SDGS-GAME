...
public class Monster {
    ...
    public int getMaxHealth() { return template.baseHealth; }
    public int getAttackDamage() { return template.baseDamage; }
    public int getType() { return template.type; }
    public int getRewardExp() { return template.rewardExp; }
    public float getSpeed() { return this.currentSpeed; }
    public float getBaseSpeed() {
        if (this.template == null) return 2.0f; 
